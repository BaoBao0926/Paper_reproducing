...
# Dataset_add = './data/ISIC2017/'
# # Tr_add = 'ISIC2017_Task1-2_Training_Input'
#
# Tr_list = glob.glob(Dataset_add + Tr_add+'/*.jpg')       # 找的是 '.data/ISIC2017/ISIC2017_Task1-2_Training_Input''

Dataset_add = r'D:\Learning_Rescoure\extra\Project\0.Project_Exercise\reproduced_code\011.UltraLight VM-UNet\UltraLight-VM-UNet-main\data\ISIC2017\\'
# Dataset_add = r'./data/ISIC2017/'
Tr_add = r'ISIC-2017_Training_Data'
