...
class setting_config:
    ...
    if datasets == 'ISIC2017':
        data_path = r'D:\Learning_Rescoure\extra\Project\0.Project_Exercise\reproduced_code\011.UltraLight VM-UNet\UltraLight-VM-UNet-main\data\ISIC2017\ISIC2017_prepared\\'
